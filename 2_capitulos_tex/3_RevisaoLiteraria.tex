...
Foi realizado uma busca exploratoria utilizando a ferramenta Google Scholar para encontrar um artigo que fosse relevante ao tema e foi encontrado \cite{kratochvila2024multi}, com o conteúdo desse foi gerado e refinado a string de busca.
