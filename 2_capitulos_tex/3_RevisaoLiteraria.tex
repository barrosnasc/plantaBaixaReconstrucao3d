...
Na busca bibliográfica, \cite{kratochvila2024multi} tornou-se o artigo principal de referência, pois cita e relaciona os demais trabalhos encontrados. A partir dele, foi possível identificar os \textit{datasets} e as técnicas predominantes aplicadas atualmente na reconstrução 3D a partir de plantas baixas.
