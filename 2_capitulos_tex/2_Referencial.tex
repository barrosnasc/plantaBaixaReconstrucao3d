...
Na etapa de reconhecimento ocorre o processamento de imagem gerando um modelo intermediário, e na reconstrução é realizado o pós-processamento e a criação do modelo 3D, com pelo menos os objetos de parede, porta e janela.
...
Na reconstrução é feita o pós-processamento para reduzir erros, é então criado o modelo 3D usando tamanhos padrão para os objetos, como altura e largura da parede. Caso a técnica permita detectar outros elementos na etapa anterior, eles são adicionados ao modelo 3D.
