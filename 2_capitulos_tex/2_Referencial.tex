...
De acordo com NBR 6492
\section{Processamento de Imagem}
É a área da ciência ... pegar do livro
\subsection{Detecção de Simbolos}
\subsection{Segmentação de Imagem}
Pixels de uma textura que estão associados a uma informação
\section{Algoritmos Heurísticos}
Algoritmos tradicionais
\section{Aprendizagem Profunda}
Técnica de aproximação de funções dado dados suficientes
\section{\textit{Datasets}}
Dados anotados para utilizar, comparar e treinar diferente tipos de dados diferentes, importante para comparar algoritmos e técnicas diferentes como mostrado nos trabalhos a seguir é dado relevância ao \texit{dataset} do CubiCasa5K
