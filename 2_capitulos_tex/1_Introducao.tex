...
\begin{itemize}
  ...
  \item Escolher a arquitetura a ser utilizada, escolhendo a com a melhor compatibilidade os requisitos de hardware disponíveis.
  \item Treinar o modelo de acordo com os \textit{datasets} da literatura, como o CubiCasa5K.
