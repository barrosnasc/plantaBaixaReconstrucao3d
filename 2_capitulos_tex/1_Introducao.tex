...
, essas características dão ao leitor os meios para poder reproduzir o que está no papel no mundo real nas construções ou em simulações. 
...
A transferência do desenho arquitetônico para a construção é algo estático e não pode ser alterado, gerando um problema se for necessário fazer uma reforma. % , onde não é mais possível utilizar a mesma planta baixa 
...
Na ausência de um modelo virtual do desenho arquitetônico poderá fazer a sua reconstrução, podendo ser manual ou através do processamento de imagem. 
Nesse projeto será utilizará o processamento de imagem, que irá extrair os objetos e características para o ambiente virtual do documento digitalizado, depois será processado para gerar uma estrutura de dados que seja capaz de manipular, e depois será transformado em um modelo 3D \cite{yang2022automated}.

As primeiras técnicas de processamento de imagem para extrair características de plantas baixas utilizava algoritmos heurísticos para poder extrair as informações da imagem. Com o avanço da ciência se percebeu que técnicas de aprendizagem profunda possuem um desempenho melhor \cite{lv2021residential}. Essas técnicas precisam de datasets para poder treinar o modelo de predição, como o CubiCasa5K \cite{cubiCasa5K} com 5 mil imagens e que foi feito utilizando plantas baixas residenciais da Finlândia.
